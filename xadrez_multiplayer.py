    ...
    async def broadcast(self, room_id: str):
        ...
        for conn in room["connections"]:
            data = {
                ...
                "board_svg": svg_data,
                "your_sid": conn["sid"],
                "is_full": room["state"]["p1"]["sid"] and room["state"]["p2"]["sid"]
            }
...
async def index():
    ...
    <html>
        ...
        <style>
            ...
            input { padding: 12px; margin: 10px; width: 80%; border-radius: 5px; border: none; }
            button { padding: 15px; width: 85%; background: #4CAF50; color: white; border: none; border-radius: 5px; cursor: pointer; }
        </style></head>
        <body>
...
async def game_page(room_id: str, nome: str):
    ...
    <html>
        ...
        <style>
            ...
            #board-container {{ margin: 20px auto; width: 320px; height: 320px; position: relative; cursor: pointer; }}
            ...
            .square:active {{ background: rgba(0, 255, 0, 0.3); }}
        ...
        <body>
            ...
            <div id="logs" style="font-size: 0.9em; color: #aaa;"></div>
...
async def websocket_endpoint(websocket: WebSocket, room_id: str, player_name: str):
    sid = await arena.connect(websocket, room_id, player_name)
    ...
    try:
        ...
        pass # Tratar desconexão se necessário
